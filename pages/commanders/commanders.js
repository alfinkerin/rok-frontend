...
function Commanders({ data, category }) {
  ...
  return (
    <div className=" w-full px-2 md:px-16  pt-28 mb-10">
      <div className="">
        Rise of Kingdom Commanders In The Rise of Kingdoms, there are Legendary,
        Epic, Elite and Advance commanders. All commanders have 4 skills and to
        unlock all 4 skills you need to upgrade stars and levels. Epic and
        Legendary have a special 5th skill that is very important. Max one by
        one commander. To upgrade skill you need to use commander sculpture or
        universal sculpture. Level 10 you will unlock 2nd skill, on level 20 you
        will unlock 3rd skill. On level 30 you will unlock 4th. Max level is 60,
        and you want your primary commander to be level 60 because of talent.
      </div>
